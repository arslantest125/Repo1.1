...
//   $result = mysqli_query($conn, $sql);
    ...
    $sql="UPDATE `donar_info` SET `firstname`='$firstname' , `userid`='$useridEdit' , `lastname`='$lastname' , `phone`='$phonenumber' , `blood`='$bloodgroup' , `province`='$province' , `city`='$city' ,
    `lasttime`='$lastname' , `address`='$address' WHERE `donarinfo` . `serialno` = $serialno";
  ...
  // Sql query to be executed
  $sql="INSERT INTO `donar_info` (`firstname`, `lastname`, `phone`, `blood`, `province`, `city`, `lasttime`, `address`, `timestamp`)
  VALUES ( '$firstname', '$lastname', '$phonenumber', '$bloodgroup', '$province', '$city', '$lasttime', '$address', current_timestamp())";
...
?>
   ...
   <!-- edit modal -->
    ...
    <div class="modal-dialog">
        ...
        <form action="/Mian Blood Bank/handleDonarinfo.php" method="POST">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="desc">last Time Donate</label>
            ...
            <div class="form-group">
              <label for="title">Address</label>
              <input type="hidden" class="form-control" id="useridEdit" name="useridEdit" aria-describedby="emailHelp">
            </div>
      ...
      <tbody>
        <?php 
          ...
          while($row = mysqli_fetch_assoc($result)){
            ...
            <td> <button class='edit btn btn-sm btn-danger' id=".$row['serialno'].">Edit</button> <button class='delete btn btn-sm btn-danger' id=d".$row['serialno'].">Delete</button>  </td>
          </tr>";
        } 
          ?>
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete this note!")) {
          console.log("yes");
          window.location = `/Mian Blood Bank/handleDonarinfo.php?delete=${serialno}`;
